...
public class RiveTexture : MonoBehaviour
{
    ...
    private void Update()
    {
        if (m_file == null)
        {
            Debug.LogError("Failed to load Rive file!");
            return;
        }
        if (m_artboard == null)
        {
            Debug.LogError("Failed to initialize Artboard from Rive file!");
            return;
        }
        if (m_camera == null)
        {
            Debug.LogError("No camera found to attach CommandBuffer!");
            return;
        }
